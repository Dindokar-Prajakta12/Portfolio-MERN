...
//                     <p className="text-gray-400">dindokarprajakta28@gmail.com</p>
//                   </div>
//                 </div>
...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        "service_qnvhvtj", // your EmailJS service ID
        "template_44ibaef", // your EmailJS template ID
        formData,
        "ofr3wqFjQDu7eswy2" // your EmailJS user/public key
      )
      .then(
        (result) => {
          setStatus("Message sent successfully!");
